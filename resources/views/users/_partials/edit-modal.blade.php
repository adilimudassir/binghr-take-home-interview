                ...
                <form action="{{ route('users.update', $user->id) }}" method="POST">
                    ...
                    <div class="p-6 flex-auto">
                        <div class="grid grid-cols-1">
                            <div class="my-3 pt-0">
                                <input type="text" name="employee_id" value="{{ $user->employee_id }}" placeholder="Employee ID *" class="px-2 py-1 placeholder-gray-500 text-gray-500 bg-white bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full" />
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-3">
                            <div class="my-3 pt-0">
                                <input type="text" name="first_name" value="{{ $user->first_name }}" placeholder="First Name *" class="px-2 py-1 placeholder-gray-500 text-gray-500 bg-white bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full" />
                            </div>
                            <div class="my-3 pt-0">
                                <input type="text" name="last_name" value="{{ $user->last_name }}" placeholder="Last Name *" class="px-2 py-1 placeholder-gray-500 text-gray-500 bg-white bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full" />
                            </div>
                        </div>
                        <div class="grid grid-cols-3 gap-3">
                            <div class="my-3 pt-0">
                                <input type="email" name="email" value="{{ $user->email }}" placeholder="Email ID *" class="px-2 py-1 placeholder-gray-500 text-gray-500 bg-white bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full" />
                            </div>
                            <div class="my-3 pt-0">
                                <input type="text" name="phone" value="{{ $user->phone }}" placeholder="Mobile No" class="px-2 py-1 placeholder-gray-500 text-gray-500 bg-white bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full" />
                            </div>
                            <div class="my-3 pt-0">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <div class="my-3 pt-0">
                                <input type="text" name="username" value="{{ $user->username }}" placeholder="Username *" class="px-2 py-1 placeholder-gray-500 text-gray-500 bg-white bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full" />
                            </div>
                        </div>
                    </div>
                    <div class="flex-auto">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-left">
                                        <input @if($user->hasPermissionTo($permission['name'])) checked @endif id="{{ $key }}" aria-describedby="{{ $permission['name'] }}" name="permissions[]" type="checkbox" value="{{ $permission['name'] }}" class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded">
                                    </td>
                                    @endforeach
                                </tr>
                                @endforeach
